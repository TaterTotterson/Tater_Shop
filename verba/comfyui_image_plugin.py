...
class ComfyUIImagePlugin(ToolVerba):
    ...
    verba_dec = "Generate a still image from a text prompt using your ComfyUI workflow."
    ...
    @staticmethod
    def get_base_http():
        settings = redis_client.hgetall(f"verba_settings:{ComfyUIImagePlugin.settings_category}") or {}

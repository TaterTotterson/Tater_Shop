...
logger = logging.getLogger("discord_admin_response_mode")
...
class DiscordAdminResponseModePlugin(ToolVerba):
    ...
    argument_schema = {
        ...
        "properties": {
            "request": {
                "type": "string",
                "description": "Response-mode command text (for example: always respond here, clear always respond).",
            },
            "query": {
                "type": "string",
                "description": "The response-mode command to run in this guild/channel context.",
            },
            ...
            "dry_run": {
                "type": "boolean",
                "description": "If true, preview effects without persisting response-mode changes.",
            },
        },
        "required": [],
    }
...
verba = DiscordAdminResponseModePlugin()

...
class EventsQueryBriefPlugin(ToolVerba):
    """
    ...
    verba_dec = "Produce a terse dashboard-friendly summary of recent home events and optionally write it to Home Assistant."

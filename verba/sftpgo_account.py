...
class SFTPGoAccountPlugin(ToolVerba):
    ...
    verba_dec = "Create an SFTPGo account for the user and return login details."
    ...
    def get_sftpgo_settings(self):
        ...
        """
        rc = self._redis()
        settings = rc.hgetall("verba_settings:SFTPGo") or {}
        defaults = {

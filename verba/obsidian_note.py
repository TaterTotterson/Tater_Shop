...
class ObsidianNotePlugin(ToolVerba):
    name = "obsidian_note"
    ...
    verba_dec = "Save markdown content to Obsidian with predictable note naming, append/overwrite controls, and tags."
    ...
    def _settings(self) -> Dict[str, str]:
        return redis_client.hgetall(f"verba_settings:{self.settings_category}") or {}

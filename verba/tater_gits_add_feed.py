...
class TaterGitsAddFeedPlugin(ToolVerba):
    ...
    platforms = ["webui", "little_spud", "macos", "discord", "irc", "meshtastic", "matrix", "telegram"]
    ...
    async def _get_cfg(self):
        try:
            ...
            s = get_verba_settings(self.settings_category)

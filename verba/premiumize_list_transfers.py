...
logger = logging.getLogger("premiumize_list_transfers")
...
class PremiumizeListTransfersPlugin(PremiumizeBasePlugin):
    ...
    tags = ["premiumize", "list_transfers"]
    fixed_action = "list_transfers"
    usage = '{"function":"premiumize_list_transfers","arguments":{"query":"what is Premiumize downloading right now"}}'
    description = "List Premiumize transfers with status counts and optional filters."
    verba_dec = "Show Premiumize transfer queue/status with active, finished, and failed counts."
    when_to_use = "Use when the request is to list transfers or check what Premiumize is downloading."
    how_to_use = "Set `query` to a transfer-list request (for example: show active transfers, list finished Premiumize downloads)."
    common_needs = ["A transfer-list request in query."]
    missing_info_prompts = []
    example_calls = [
        '{"function":"premiumize_list_transfers","arguments":{"query":"what is Premiumize downloading right now"}}',
        '{"function":"premiumize_list_transfers","arguments":{"query":"show finished Premiumize transfers"}}',
    ]
    routing_keywords = [
        "premiumize",
        "transfers",
    ...
    argument_schema = {
        ...
        "properties": {
            "query": {
                "type": "string",
                "description": "The transfer-list request (for example: show active transfers, list failed transfers).",
            },
            "status_filter": {
                "type": "string",
                "description": "Optional filter: active, finished, failed, or all.",
            },
            "name_query": {
                "type": "string",
...
verba = PremiumizeListTransfersPlugin()

...
logger = logging.getLogger("premiumize_list_files")
...
class PremiumizeListFilesPlugin(PremiumizeBasePlugin):
    ...
    tags = ["premiumize", "list_files"]
    fixed_action = "list_files"
    usage = '{"function":"premiumize_list_files","arguments":{"query":"show my Premiumize files"}}'
    description = "Browse Premiumize cloud files/folders."
    verba_dec = "List Premiumize cloud folder contents with file/folder counts."
    when_to_use = "Use when the request is to browse/list Premiumize cloud files or folders."
    how_to_use = "Set `query` to a file-browsing request (for example: show my Premiumize files, list files in folder abc123)."
    common_needs = ["A file-browsing request in query."]
    missing_info_prompts = []
    example_calls = [
        '{"function":"premiumize_list_files","arguments":{"query":"show my Premiumize files"}}',
        '{"function":"premiumize_list_files","arguments":{"query":"list files in folder abc123"}}',
    ]
    routing_keywords = ["premiumize", "files", "file", "folder", "browse", "cloud"]
    argument_schema = {
        "type": "object",
        "properties": {
            "query": {
                "type": "string",
                "description": "The file-browse request (for example: show files, list folder abc123).",
            },
            "folder_id": {
                "type": "string",
                "description": "Optional explicit Premiumize folder id.",
            },
            "name_query": {
                "type": "string",
                "description": "Optional file/folder name filter text.",
            },
            "index": {
                "type": "integer",
                "description": "Optional 1-based index hint for related transfer/file selection.",
            },
        },
        "required": [],
    }

...
class PremiumizeListFilesPlugin(ToolVerba):
    ...
    description = (
        "Browse Premiumize cloud files/folders."
    )
    verba_dec = (
        "List Premiumize cloud folder contents with file/folder counts."
    )
    ...
    when_to_use = (
        "Use when the request is to browse/list Premiumize cloud files or folders."
    )
    how_to_use = (
        "Set `query` to a file-browsing request (for example: show my Premiumize files, list files in folder abc123)."
    )
    common_needs = [
        "A file-browsing request in query.",
    ]

...
class WebDAVBrowserPlugin(ToolVerba):
    name = "webdav_browser"
    verba_name = "WebDAV Browser"
    version = "1.0.1"
    min_tater_version = "59"
    usage = '{"function":"webdav_browser","arguments":{}}'
    description = "Lets the user browse and download files from the WebDAV server."
    verba_dec = "Browse and download files from the configured WebDAV server."
    ...
    @staticmethod
    def get_settings():
        settings = redis_client.hgetall("verba_settings:WebDAVBrowser")
        return {

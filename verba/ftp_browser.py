...
class FtpBrowserPlugin(ToolVerba):
    name = "ftp_browser"
    verba_name = "FTP Browser"
    version = "1.1.1"
    min_tater_version = "59"
    usage = '{"function":"ftp_browser","arguments":{}}'
    description = "Lets the user browse and download files from the FTP server."
    verba_dec = "Browse and download files from the configured FTP server."
    ...
    def _load_settings(cls) -> Dict[str, str]:
        keys = [
            "verba_settings: FTP Browser",
            "verba_settings:FTP Browser",
            "verba_settings: FTPBrowser",
            "verba_settings:FTPBrowser",
            f"verba_settings: {cls.settings_category}",
            f"verba_settings:{cls.settings_category}",
        ]
        merged: Dict[str, str] = {}
        for key in keys:

...
logger = logging.getLogger("moltbook_profile_link")
...
class MoltbookProfileLinkPlugin(ToolVerba):
    name = "moltbook_profile_link"
    verba_name = "Moltbook Profile Link"
    version = "1.0.0"
    min_tater_version = "59"
    pretty_name = "Moltbook Profile Link"
    settings_category = "Moltbook Info"
    tags = ['moltbook', 'profile_link']
    fixed_route = "profile_link"
    platforms = ['webui', 'macos', 'homeassistant', 'homekit', 'xbmc', 'discord', 'telegram', 'matrix', 'irc']

    usage = (
        "{\"function\":\"moltbook_profile_link\",\"arguments\":{\"query\":\"what is your Moltbook profile link\"}}"
    )
    description = (
        "Return the Moltbook profile link for this agent."
    )
    verba_dec = "Get the current Moltbook profile URL."
    when_to_use = (
        "Use when the user asks for your Moltbook profile link or URL."
    )
    how_to_use = (
        "Set `query` to a profile-link request (for example: what is your Moltbook profile link)."
    )
    common_needs = ['A Moltbook profile-link request in query.']
    routing_keywords = ['moltbook', 'profile link', 'profile url', 'profile']
    missing_info_prompts = []
    example_calls = ['{"function":"moltbook_profile_link","arguments":{"query":"what is your Moltbook profile link"}}', '{"function":"moltbook_profile_link","arguments":{"query":"share your Moltbook profile URL"}}']
    argument_schema = {'type': 'object', 'properties': {'query': {'type': 'string', 'description': 'The profile-link request (for example: what is your profile URL).'}}, 'required': []}
...
verba = MoltbookProfileLinkPlugin()

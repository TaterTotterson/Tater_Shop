...
class PremiumizeGetLinksPlugin(PremiumizeBasePlugin):
    ...
    description = (
        "Retrieve Premiumize direct/stream links for magnets, remote .torrent URLs, attached .torrent files, or local/downloaded .torrent files."
    )
    verba_dec = (
        "Get Premiumize stream/download links by magnet links, remote HTTP(S) .torrent URLs, attached .torrent files, or local/downloaded .torrent files."
    )
    when_to_use = (
        "Use when the request is for Premiumize download/stream links from a magnet, a remote .torrent link, an attached .torrent file, or a local/downloaded .torrent file."
    )
    how_to_use = (

...
class DeviceComparePlugin(ToolVerba):
    ...
    verba_dec = "Natural-language device comparison with spec tables and optional per-game FPS benchmarks."
    ...
    def _get_settings(self):
        s = redis_client.hgetall(f"verba_settings:{self.settings_category}") or redis_client.hgetall(

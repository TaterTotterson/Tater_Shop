...
class WeatherBriefPlugin(ToolVerba):
    """
    ...
    verba_dec = "Give a short automation-friendly recap of recent weather conditions."
    ...
    def _get_settings(self) -> Dict[str, str]:
        s = redis_client.hgetall(f"verba_settings:{self.settings_category}") or \

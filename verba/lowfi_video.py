...
class _ComfyUIImageHelper:
    ...
    @staticmethod
    def get_base_http():
        settings = redis_client.hgetall(f"verba_settings:{_ComfyUIImageHelper.settings_category}")
...
class _ComfyUIImageVideoHelper:
    ...
    def get_base_http() -> str:
        settings = redis_client.hgetall(f"verba_settings:{_ComfyUIImageVideoHelper.settings_category}")
...
class LowfiVideoPlugin(ToolVerba):
    ...
    verba_dec = "Create a cozy ComfyUI lofi video by generating music and looping a matching animation."
    ...
    async def handle_webui(self, args, llm_client):
        ...
        settings = self._decode_map(redis_client.hgetall(f"verba_settings:{self.settings_category}"))
